...
public class AllTherapistAdapter extends RecyclerView.Adapter<AllTherapistAdapter.ViewHolder> {

    private List<Therapist> therapistList;

    private Context context;

    private AllTherapistAdapter.OnHomeTherapistItemClickListener listener;

    private FirebaseFirestore db;

    private FirebaseStorage storage;

    public AllTherapistAdapter(List<Therapist> therapistList, AllTherapistAdapter.OnHomeTherapistItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AllTherapistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_home_therapist, parent, false);
        context = parent.getContext();
        return new AllTherapistAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllTherapistAdapter.ViewHolder holder, int position) {
