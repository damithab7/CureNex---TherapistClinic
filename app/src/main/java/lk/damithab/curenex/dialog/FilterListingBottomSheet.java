...
public class FilterListingBottomSheet extends BottomSheetDialogFragment {

    private OnScheduleAddedListener listener;

    private FilterListingBottomSheetBinding binding;
    ...
    public FilterListingBottomSheet(OnScheduleAddedListener listener) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FilterListingBottomSheetBinding.inflate(inflater, container, false);
